...
- ~~**D-12 рассинхрон**~~ Закрыт 2026-05-15. Y1-Y5 = 5 лет финально
  (заказчик подтвердил повторно, см. `CLIENT_FEEDBACK_v2_DECISIONS.md`
  Q5). `s11_kpi.py:50 SCOPE_BOUNDS["y1y5"] = (5, 5)` корректен, docstring
  и `TZ_VS_EXCEL_DISCREPANCIES.md` D-12 синхронизированы.
...
| LOGIC-08 | D-12 Y1-Y5 уточнение у заказчика | ✅ Закрыт 2026-05-15 (5 лет финально) |
