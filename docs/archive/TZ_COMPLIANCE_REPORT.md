...
> **🗄️ Архивный документ.** Замещён в 2026-04-15 файлом
> [`docs/TZ_VS_EXCEL_DISCREPANCIES.md`](../TZ_VS_EXCEL_DISCREPANCIES.md),
> который покрывает D-01..D-24 расхождений с Excel-эталоном и их
> финальные решения. Этот отчёт оставлен для истории (snapshot
> compliance по коммиту b3ffb35).
