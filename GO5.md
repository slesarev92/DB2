...
### Фаза C — 18/19 ✅ (закрыта; #28 skipped — требует спеки заказчика)

| # | Что | Статус |
|---|---|---|
| 13 | Q4 OBPPC в «Основа» | ✅ 2026-05-16 |
| 14 | Fine Tuning per-period | ✅ 2026-05-15 |
| 15 | P&L Pivot Excel экспорт | ✅ 2026-05-17 |
| 16 | Каналы: группы + source_type + bulk endpoint | ✅ 2026-05-16 |
| 17 | АКБ автоматический расчёт (nd × ОКБ) | ✅ 2026-05-17 |
| 18 | Waterfall в Unit-эконмике | ✅ 2026-05-17 |
...
### Backlog Фазы C — 0 items open 🎉

**Skipped:**
- **#28** Подсветка BOM — требует спеки заказчика (что подсвечиваем, какой порог)
