...
- ТЗ_Цифровой_паспорт_проекта_V3.docx
- Predikt-k-TZ-V3.xlsx
- ПАСПОРТ_МОДЕЛЬ_GORJI__05-09-25.xlsx
- ПАСПОРТ_ЭЛЕКТРА___ZERO_09-08-2025.pdf
- Примеры_выдачи_паспорта.pptx
- Дополнение_к_ТЗ_паспорта_проекта.pdf
...
**Excel-модель `ПАСПОРТ МОДЕЛЬ GORJI+ 05-09-25.xlsx` является единственным
